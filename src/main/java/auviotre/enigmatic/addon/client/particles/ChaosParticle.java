...
@OnlyIn(Dist.CLIENT)
public class ChaosParticle extends SimpleAnimatedParticle {
    protected ChaosParticle(ClientLevel level, double posX, double posY, double posZ, double dx, double dy, double dz, SpriteSet spriteSet) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level, double posX, double posY, double posZ, double speedX, double speedY, double speedZ) {
            return new ChaosParticle(level, posX, posY, posZ, speedX, speedY, speedZ, this.sprite);
        }
    }
}
