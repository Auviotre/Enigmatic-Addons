...
### Features:
- 2 new Item (**Scepter of Extradimension**, **Magic Quartz Flower**);
- 1 new Advancements;
- Remade the **Redemption** ceremony:
  - The amount of Blessings will depend on the time of wearing **the Ring of Seven Curses** when you performed the ceremony;
  - Using the **Cursed** items while wearing the **Ring of Redemption** will gradually break the ring;
...
- The Damage Limit of **the Cube** now is configurable;
- A lot of items now are fire-resistant reasonably.
### Fixes:
- Now players will prioritize using **Totem of Malice** that is effective;
***
## [Release 1.2.2] (2025/02/15)
### Features:
...
- Now the unbreakable repair cost of the **Forger's Gem** is configurable;
- Now the effect **Ichor Corrosion** will boost the damage received;
- Changed the max boost level of **Tome of Divination** to the 150% of original max level;
- Changed the effect of the **Scroll of Ignorance Curse**;
- Changed the effect of the **Totem of Malice**;
